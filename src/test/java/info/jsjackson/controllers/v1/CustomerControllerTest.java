...
public class CustomerControllerTest extends AbstractRestControllerTest {
	...
	public void testUpdateCustomer() throws Exception {
		...
		//When/Then
		mockMvc.perform(put(CustomerController.BASE_URL + "/" + ID3)
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJsonString(customerDTO)))
		.andExpect(status().isOk())
		.andExpect(jsonPath("$.firstName", equalTo(FIRST_NAME3)))
	...
	public void testPatchCustomer() throws Exception {
		...
		returnDTO.setCustomerUrl(CustomerController.BASE_URL + "/" + ID3);
		
		
		when(customerService.patchCustomer(anyLong(),  any(CustomerDTO.class))).thenReturn(returnDTO);
		
		//When/Then
		mockMvc.perform(patch(CustomerController.BASE_URL + "/" + ID3)
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJsonString(customerDTO)))
		.andExpect(status().isOk())
		.andExpect(jsonPath("$.firstName", equalTo(FIRST_NAME3)))
		.andExpect(jsonPath("$.lastName", equalTo("Jackson")))
		.andExpect(jsonPath("$.customer_url", equalTo(CustomerController.BASE_URL + "/" + ID3)))
		.andReturn();
	...
	public void testPatchCustomerDEBUG() throws Exception {
		...
		//When/Then
		String response = mockMvc.perform(patch(CustomerController.BASE_URL + "/" + ID3)
				.contentType(MediaType.APPLICATION_JSON)
				.content(asJsonString(customerDTO)))
		.andReturn().getResponse().getContentAsString();
	...
	public void testDeleteCustomerById() throws Exception {
		...
		//When/Then
		mockMvc.perform(delete(CustomerController.BASE_URL + "/" + ID3)
				.contentType(MediaType.APPLICATION_JSON))
		.andExpect(status().isOk())
		.andReturn();
